...
<div class="product-our">
              <h2 class="product-our-title">PRODUCT DETAIL</h2> 
      ...
      while ($prd = mysqli_fetch_array($rs1)) { ?>
        <div class="product_detail1">
          <div class="product_info1">
            <img src='image\<?= $prd['productImg']?>' width="250" height="250"> 
            <br> <br>
            Name: <?= $prd['productName'] ?> <br> <br>
            Price: <?php echo $prd['productPrice'] ." " . "$" ?> <br> <br>
            <?php
            $scategory = $prd['productCategory'];
            $sql2 = "SELECT categoryName FROM category WHERE categoryId = '$scategory'";
            $rst2 = execute_query($sql2);
